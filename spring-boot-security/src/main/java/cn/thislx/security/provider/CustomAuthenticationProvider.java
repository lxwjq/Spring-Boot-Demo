package cn.thislx.security.provider;

import cn.thislx.security.auth.CustomWebAuthenticationDetails;
import cn.thislx.security.service.CustomUserDetailsService;
...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        // 如果是自定义AuthenticationProvider，需要手密码校验
